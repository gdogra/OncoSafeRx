  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Building Your Support Network</h1>
        <span className="text-sm text-gray-600 dark:text-gray-400">Type: VIDEO • 12 min</span>
      </div>
      ...
      <Card>
        <div className="space-y-4">
          ...
          <p className="text-gray-700 dark:text-gray-300">Tips for communicating with family and friends about your cancer journey and creating a strong support system.</p>
          ...
          <h2 className="flex items-center space-x-2 text-lg font-semibold text-gray-900 dark:text-gray-100"><Users className="w-5 h-5" /><span>Practical Steps</span></h2>
