    ...
    if (isPrimary) {
      return `flex flex-col items-center space-y-1 py-2 px-3 rounded-xl transition-all duration-200 ${
        isCurrentPath
          ...
          : 'text-gray-600 hover:text-primary-600 hover:bg-gray-50 active:bg-gray-100 dark:bg-gray-800'
      }`;
    }
      ...
      <header className="bg-white shadow-sm border-b border-gray-200 sticky top-0 z-40">
        <div className="flex items-center justify-between px-4 py-3">
          ...
          <Link to="/" className="flex items-center space-x-2">
            ...
            <div>
              <h1 className="text-lg font-bold text-gray-900 dark:text-gray-100">OncoSafeRx</h1>
          ...
          <div className="flex items-center space-x-3">
            {/* Notifications */}
            <button className="relative p-2 text-gray-400 hover:text-gray-600 rounded-lg hover:bg-gray-100 dark:bg-gray-800">
        ...
        <div className="absolute right-0 top-0 h-full w-80 bg-white shadow-xl">
          <div className="flex flex-col h-full">
            ...
            <div className="flex-1 overflow-y-auto">
              {/* Quick Stats */}
              <div className="p-4 bg-gray-50 border-b border-gray-200 dark:border-gray-700">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="bg-white rounded-lg p-3 text-center">
                    ...
                    <div className="text-xs text-gray-600 dark:text-gray-400">Critical Alerts</div>
                  </div>
                </div>
              </div>
            ...
            <div className="p-4 border-t border-gray-200 bg-gray-50 dark:bg-gray-800">
              <div className="flex items-center space-x-3 mb-3">
                ...
                <div>
                  <div className="text-sm font-medium text-gray-900 dark:text-gray-100">Dr. Clinical User</div>
                  <div className="text-xs text-gray-500 dark:text-gray-400">Oncology Department</div>
                </div>
              </div>
