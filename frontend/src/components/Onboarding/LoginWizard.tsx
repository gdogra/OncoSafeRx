  ...
  const stepsForArea = (a: TourArea | 'comprehensive'): Step[] => {
    if (a === 'comprehensive') {
      const steps: Step[] = [
        ...
        { id: '/evidence-analysis', title: 'Evidence Analysis', description: 'Synthesize evidence across sources. How to use: use the search and filters, then review tabs for sources, updates, analysis, and models.', cta: { label: 'Open Evidence Analysis', to: '/evidence-analysis' }, target: '[data-tour="evidence-filters"]' },
        { id: '/drug-intelligence', title: 'Drug Intelligence', description: 'Live integrations (DailyMed, OpenFDA, ClinicalTrials.gov). How to use: enter a drug, run search, then compare sources; try the interactions tab.', cta: { label: 'Open Drug Intelligence', to: '/drug-intelligence' }, target: '[data-tour="drug-intel-search"]' },
        { id: '/multi-database-search', title: 'Multi‑Database Search', description: 'Federated search across PubMed, trials, labels. How to use: enter a query, pick databases, set filters, then review results.', cta: { label: 'Open Multi‑DB Search', to: '/multi-database-search' }, target: '[data-tour="multi-search-query"]' },
    ...
    switch (a) {
      ...
      case 'drug_info':
        return [
          ...
          { id: '/evidence-analysis', title: 'Evidence Analysis', description: 'Use filters then explore analysis tabs for sources, updates, analysis, and models.', cta: { label: 'Open Evidence Analysis', to: '/evidence-analysis' }, target: '[data-tour="evidence-tabs"]' },
          { id: '/drug-intelligence', title: 'Drug Intelligence', description: 'Search a drug and compare results across sources; use the interactions tab for pairwise checks.', cta: { label: 'Open Drug Intelligence', to: '/drug-intelligence' }, target: '[data-tour="drug-intel-interactions"]' },
          { id: '/multi-database-search', title: 'Multi‑Database Search', description: 'Enter query, select databases, set filters (date/type/level), then inspect ranked results.', cta: { label: 'Open Multi‑DB Search', to: '/multi-database-search' }, target: '[data-tour="multi-search-filters"]' },
          ...buildStepsFromPaths(['/biostatistics'])
        ];
      case 'interactions':
        return [
