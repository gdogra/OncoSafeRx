    ...
    <div className="space-y-6">
      ...
      <div className="text-center">
        <div className="flex items-center justify-center space-x-2 mb-4">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">EHR Integration</h1>
            ...
            <div className="space-y-6">
              <div>
                <div className="flex items-center space-x-2 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Search EHR Patients</h3>
                ...
                <div className="flex space-x-3">
                  <input
                    ...
                    className="flex-1 border border-gray-300 rounded-md px-3 py-2 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 disabled:bg-gray-100 dark:bg-gray-800"
                  />
                  <button
          ...
          {activeTab === 'import' && (
            <div className="space-y-6">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Import Patient Data</h3>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <Card>
                  <div className="text-center py-6">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Basic patient information, contact details, and identifiers</p>
                  </div>
                </Card>
                ...
                <Card>
                  <div className="text-center py-6">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Medications, allergies, conditions, and treatment history</p>
                  </div>
                </Card>
                ...
                <Card>
                  <div className="text-center py-6">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Laboratory values, vital signs, and diagnostic results</p>
                  </div>
                </Card>
              </div>
          ...
          {activeTab === 'export' && (
            <div className="space-y-6">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Export Patient Data</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid md:grid-cols-4 gap-4 text-sm">
                    <div className="text-center p-3 bg-gray-50 rounded">
                      <div className="font-medium text-gray-900 dark:text-gray-100">{state.currentPatient.allergies.length}</div>
                      <div className="text-gray-600 dark:text-gray-400">Allergies</div>
                    </div>
                    <div className="text-center p-3 bg-gray-50 rounded">
                      <div className="font-medium text-gray-900 dark:text-gray-100">{state.currentPatient.medications.filter(m => m.isActive).length}</div>
                      <div className="text-gray-600 dark:text-gray-400">Active Medications</div>
                    </div>
                    <div className="text-center p-3 bg-gray-50 rounded">
                      <div className="font-medium text-gray-900 dark:text-gray-100">{state.currentPatient.conditions.length}</div>
                      <div className="text-gray-600 dark:text-gray-400">Conditions</div>
                    </div>
                    <div className="text-center p-3 bg-gray-50 rounded">
                      <div className="font-medium text-gray-900 dark:text-gray-100">{state.currentPatient.labValues.length}</div>
                      <div className="text-gray-600 dark:text-gray-400">Lab Values</div>
                    </div>
                  </div>
                </div>
              ) : (
          ...
          {activeTab === 'settings' && (
            <div className="space-y-6">
              <div className="flex items-center space-x-2 mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Connection Settings</h3>
                ...
                <Card>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center space-x-2 text-sm">
                      ...
                      <span className="text-gray-600 dark:text-gray-400">HTTPS Encryption: Enabled</span>
                    </div>
                    <div className="flex items-center space-x-2 text-sm">
                      <CheckCircle className="w-4 h-4 text-green-600" />
                      <span className="text-gray-600 dark:text-gray-400">FHIR R4 Compliance: Yes</span>
                    </div>
                    <div className="flex items-center space-x-2 text-sm">
                      <Clock className="w-4 h-4 text-yellow-600" />
                      <span className="text-gray-600 dark:text-gray-400">Token Auth: {process.env.REACT_APP_FHIR_AUTH_TOKEN ? 'Configured' : 'Not configured'}</span>
                    </div>
                  </div>
                </Card>
              </div>
