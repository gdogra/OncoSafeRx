  ...
  return (
    <div className="fixed inset-0 z-50">
      ...
      <div className="absolute inset-0 flex items-center justify-center p-4">
        <div className="w-full max-w-xl bg-white rounded-lg shadow-xl border border-gray-200 dark:border-gray-700">
          <div className="p-4 border-b flex items-center justify-between">
            <div>
              <div className="text-xs text-gray-500 dark:text-gray-400">Feature Tour</div>
          ...
          <div className="p-3 border-t flex items-center justify-between">
            <div className="text-xs text-gray-500 dark:text-gray-400">Step {index + 1} of {steps.length}</div>
            <div className="flex items-center gap-2">
              ...
              {step.onCta && step.ctaLabel && (
                <button onClick={step.onCta} className="px-2 py-1 text-xs border rounded bg-gray-50 hover:bg-gray-100 dark:bg-gray-800">{step.ctaLabel}</button>
              )}
