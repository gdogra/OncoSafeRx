...
import precisionOncologyRoutes from './routes/precisionOncologyRoutes.js';
import digitalTwinRoutes from './routes/digitalTwinRoutes.js';
import liquidBiopsyRoutes from './routes/liquidBiopsyRoutes.js';
import realTimeBiomarkerRoutes from './routes/realTimeBiomarkerRoutes.js';
import multiOmicsRoutes from './routes/multiOmicsRoutes.js';
import clinicalDecisionRoutes from './routes/clinicalDecisionRoutes.js';
import patientSimulationRoutes from './routes/patientSimulationRoutes.js';
import continuousLearningRoutes from './routes/continuousLearningRoutes.js';
...
app.use('/api/precision-oncology', precisionOncologyRoutes);
app.use('/api/digital-twin', digitalTwinRoutes);
app.use('/api/liquid-biopsy', liquidBiopsyRoutes);
app.use('/api/biomarker-monitoring', realTimeBiomarkerRoutes);
app.use('/api/multi-omics', multiOmicsRoutes);
app.use('/api/clinical-decision', clinicalDecisionRoutes);
app.use('/api/patient-simulation', patientSimulationRoutes);
